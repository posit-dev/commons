...
<!-- commons:if has_multiple_sources -->
...
<!-- commons:if has_dictionary_context -->
# About the data

{{ data.dictionary_context }}
<!-- commons:if has_glossary_context -->
...
<!-- commons:if definitions_complete -->
