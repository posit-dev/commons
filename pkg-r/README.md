...
<img src="man/figures/README-trust-flow.png" alt="A question first searches trusted calculations. The high-trust path runs a relevant trusted calculation and ends with a green check-shield marker. The lower-trust path searches context and writes custom SQL or R, ending with either a blue quote-mark citation marker or a yellow exclamation marker." width="100%" />
