...
```{r}
#| echo: false
#| fig-alt: "A screencast demonstrating a commons data agent answering questions with a trusted calculation and then a direct data query. In the first case, a provenance marker reads 'Verified answer', while in the second it reads 'Untrusted'."
