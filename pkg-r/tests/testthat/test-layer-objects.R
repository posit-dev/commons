test_that("layer constructors return private R6 objects", {
  ...
  expect_identical(data_source_state(source), object_private(source))
  expect_identical(semantic_layer_state(semantic), object_private(semantic))
  expect_identical(context_layer_state(context), object_private(context))
