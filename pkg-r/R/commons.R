...
#'   `OpenTelemetry.AllowContentInstrumentation = true`. Traces then land in
#'   Connect's observability store (browsable in its Trace Viewer); commons
#'   switches on the content's *Content Observability* setting itself when
#'   needed, though capture only starts once the content restarts. Read
