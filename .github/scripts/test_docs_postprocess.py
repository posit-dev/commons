...
ROOT = "pkg-py"
BLOB = "https://github.com/posit-dev/commons/blob"
...
class StripVersionBadgeTest(unittest.TestCase):
    ...
    def test_leaves_a_longer_class_alone(self):
        ...
        self.assertIsNone(fix(page, BASE, ROOT, "./"))
...
class RelativizeIconsTest(unittest.TestCase):
    ...
    def test_leaves_a_page_needing_nothing(self):
        self.assertIsNone(fix("<html><body>plain</body></html>", BASE, ROOT, "./"))
    ...
    def test_is_idempotent(self):
        ...
        once = fix(page, BASE, ROOT, "../")
        assert once is not None
        self.assertIsNone(fix(once, BASE, ROOT, "../"))
