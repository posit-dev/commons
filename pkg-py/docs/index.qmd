...
```{=html}
<img src="assets/hex/commons-hex.png" class="commons-hex" alt="The package's hex sticker; a Common Kingfisher drawn in a cartoonish style, sitting on a park bench with a plaque reading 'commons'. Behind the bird is an open green space.">
```
