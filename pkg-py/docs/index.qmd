...
When you construct a data source, commons validates each definition and compiles it to the SQL dialect of the source. A definition on a table that the source does not expose is a construction error.
