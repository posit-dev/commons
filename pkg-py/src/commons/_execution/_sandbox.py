...
def sandbox_capabilities() -> SandboxCapabilities:
    ...
    user-namespace probe is asked in a throwaway fork, since unshare
    refuses a multi-threaded process. Whatever a probe restricts, it
    restricts in the child, so probing leaves the calling process as
