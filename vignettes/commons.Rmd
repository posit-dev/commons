...
helps coding agents build, evaluate, and improve commons agents. Installing the
R package makes the skill files available, but does not automatically add them
to an assistant's skill discovery directory.
